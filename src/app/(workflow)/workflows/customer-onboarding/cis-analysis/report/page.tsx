...
const WORKFLOW_RETURN_URL = '/workflows/customer-onboarding/cis-analysis';
...
export default function WorkflowRiskReportPage() {
    ...
    return (
      <div className="flex flex-col min-h-screen bg-background">
        ...
        <div className="flex-1 p-6">
          <div className="border rounded-lg p-12 text-center text-muted-foreground max-w-6xl mx-auto">
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background">
      {/* Workflow Header */}
      <header className="shrink-0 border-b bg-background px-6 py-3 print:hidden">
